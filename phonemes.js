...
const fr_voyelles_orales = new PhonemeGroup('voyelles orales', [
    ...
    new Phoneme('e', 'ee', 'voyelle orale', 'Close-mid front unrounded vowel', ['é','er', 'ez', 'et', 'es', 'ai'], ['Étoile', 'dansER', 'nEZ', 'ET', 'dES', 'mAI'], '___', 'https://en.wikipedia.org/wiki/Close-mid_front_unrounded_vowel', 'https://upload.wikimedia.org/wikipedia/commons/6/6c/Close-mid_front_unrounded_vowel.ogg', '___', '___'),
