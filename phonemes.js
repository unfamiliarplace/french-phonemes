...
const fr_voyelles_orales = new PhonemeGroup('voyelles orales', [
    ...
    new Phoneme('e', 'ee', 'voyelle orale', 'Close-mid front unrounded vowel', ['é','er', 'ez', 'ed', 'ef', 'et', 'es', 'ai'], ['Étoile', 'dansER', 'nEZ', 'piED', 'clEF', 'ET', 'dES', 'mAI'], '___', 'https://en.wikipedia.org/wiki/Close-mid_front_unrounded_vowel', 'https://upload.wikimedia.org/wikipedia/commons/6/6c/Close-mid_front_unrounded_vowel.ogg', '___', '___'),
    new Phoneme('ɛ', 'eh', 'voyelle orale', 'Open-mid front unrounded vowel', ['è', 'et', 'ê', 'ei', 'ai', 'e'], ['flÈche', 'sifflET', 'fÊte', 'nEIge', 'chAIse', 'cErf'], '___', 'https://en.wikipedia.org/wiki/Open-mid_front_unrounded_vowel', 'https://upload.wikimedia.org/wikipedia/commons/7/71/Open-mid_front_unrounded_vowel.ogg', '___', '___'),
...
const fr_consonnes_occlusives = new PhonemeGroup('consonnes occlusives', [
    new Phoneme('p', 'p', 'consonne occlusive', 'Voiceless bilabial plosive', ['p', 'pp'], ['PaPillon', 'hiPPopotame'], 'no', 'https://en.wikipedia.org/wiki/Voiceless_bilabial_plosive', 'https://upload.wikimedia.org/wikipedia/commons/5/51/Voiceless_bilabial_plosive.ogg', 'uwo', 'un'),
    ...
    new Phoneme('t', 't', 'consonne occlusive', 'Voiceless alveolar plosive', ['t', 'tt', 'th'], ['TomaTe', 'caroTTE', 'THé'], 'no', 'https://en.wikipedia.org/wiki/Voiceless_dental_and_alveolar_plosives#Dental_or_denti-alveolar', 'https://upload.wikimedia.org/wikipedia/commons/0/02/Voiceless_alveolar_plosive.ogg', 'uwo', 'un'),
    new Phoneme('d', 'd', 'consonne occlusive', 'Voiced alveolar plosive', ['d', 'dd'], ['Dé', 'aDDition'], 'no', 'https://en.wikipedia.org/wiki/Voiced_dental_and_alveolar_plosives#Dental_or_denti-alveolar', 'https://upload.wikimedia.org/wikipedia/commons/0/01/Voiced_alveolar_plosive.ogg', 'uwo', 'un'),
    new Phoneme('k', 'k', 'consonne occlusive', 'Voiceless velar plosive', ['c', 'k', 'qu', 'q', 'ch', 'ck', 'cc'], ['Canard', 'Koala', 'QUeue', 'cinQ', 'orCHestre', 'hoCKey', 'aCCordion'], 'no', 'https://en.wikipedia.org/wiki/Voiceless_velar_plosive', 'https://upload.wikimedia.org/wikipedia/commons/e/e3/Voiceless_velar_plosive.ogg', 'uwo', 'un'),
...
const fr_consonnes_fricatives = new PhonemeGroup('consonnes fricatives', [
    new Phoneme('f', 'f', 'consonne fricative', 'Voiceless labiodental fricative', ['f', 'ff', 'ph'], ['Fourmi', 'coiFFeur', 'éléPHant'], 'no', 'https://en.wikipedia.org/wiki/Voiceless_labiodental_fricative', 'https://upload.wikimedia.org/wikipedia/commons/c/c7/Voiceless_labio-dental_fricative.ogg', 'uwo', 'un'),
    ...
    new Phoneme('s', 's', 'consonne fricative', 'Voiceless alveolar sibilant', ['s', 'ss', 'sc', 'c', 'ç', 't', 'x'], ['Savon', 'poiSSOn', 'piSCine', 'Cerise', 'garÇon', 'poTion', 'diX'], 'no', 'https://en.wikipedia.org/wiki/Voiceless_alveolar_fricative#Voiceless_alveolar_sibilant', 'https://upload.wikimedia.org/wikipedia/commons/a/ac/Voiceless_alveolar_sibilant.ogg', 'uwo', 'un'),
...
const fr_consonnes_nasales = new PhonemeGroup('consonnes nasales', [
    new Phoneme('m', 'm', 'consonne nasale', 'Voiced bilabial nasal', ['m', 'mm'], ['Maison', 'poMME'], 'no', 'https://en.wikipedia.org/wiki/Voiced_bilabial_nasal', 'https://upload.wikimedia.org/wikipedia/commons/a/a9/Bilabial_nasal.ogg', 'uwo', 'un'),
    new Phoneme('n', 'n', 'consonne nasale', 'Voiced alveolar nasal', ['n', 'nn'], ['Neige', 'aNNiversaire'], 'no', 'https://en.wikipedia.org/wiki/Voiced_dental,_alveolar_and_postalveolar_nasals', 'https://upload.wikimedia.org/wikipedia/commons/2/29/Alveolar_nasal.ogg', 'uwo', 'un'),
...
const fr_consonnes_liquides = new PhonemeGroup('consonnes liquides', [
    new Phoneme('l', 'l', 'consonne liquide', 'Voiced alveolar lateral approximant', ['l', 'll'], ['Lion', 'baLLe'], 'no', 'https://en.wikipedia.org/wiki/Voiced_dental,_alveolar_and_postalveolar_lateral_approximants', 'https://upload.wikimedia.org/wikipedia/commons/b/bc/Alveolar_lateral_approximant.ogg', 'uwo', 'un'),
    new Phoneme('R', 'r', 'consonne liquide', 'Voiced uvular fricative', ['r', 'rr'], ['Robot', 'caRRé'], 'no', 'https://en.wikipedia.org/wiki/Voiced_uvular_fricative', 'https://upload.wikimedia.org/wikipedia/commons/a/af/Voiced_uvular_fricative.ogg', 'uwo', 'un'),
])
